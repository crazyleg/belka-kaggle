...
modelxgb = xgb.XGBClassifier(eval_metric='map',n_estimators=100)
modelxgb.load_model('/home/anonymous/belka/systematic/mega_ml/xgb.model')
# Model
model =  GATBasedMolecularGraphNeuralNetwork194(hidden_size = 64, num_gcn_layers=6).to(device)
model.load_state_dict(torch.load('/home/anonymous/belka/systematic/mega_ml/models/tmp/domain_103_e5.pth'))
...
df.to_csv('/home/anonymous/belka/domain_103_e5.csv', index=False)  # index=False means do not write row numbers