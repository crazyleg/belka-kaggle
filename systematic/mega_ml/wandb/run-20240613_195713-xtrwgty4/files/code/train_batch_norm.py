...
model.load_state_dict(torch.load('systematic/mega_ml/models/tmp/226-e5.pth'))
...
for epoch in range(1, args.epochs + 1):
    ...
    torch.save(model.state_dict(), 'model_batchnorm_fixed_from226e5.pth')
    wandb.save('model_batchnorm_fixed_from226e5.pth')
