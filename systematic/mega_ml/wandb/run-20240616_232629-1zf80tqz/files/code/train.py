...
# Model
model = GNNEncoder(hidden_size = 64, num_gcn_layers=6).to(device)
model.load_state_dict(torch.load('systematic/mega_ml/models/tmp/contrastive_pretrainedoptimizer_encoder.pth'))
